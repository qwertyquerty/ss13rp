        ...
        try:
            ...
            if len(server) == 5:
                try:
                    ...
                    elif server[0] in ["Goonstation #2","Goonstation RP #1"]:
                        details = status["map_name"]+" | "+str(status["players"])+" players"

                    if server[0] in ["Goonstation #2","Goonstation RP #1", "BeeStation", "FTL13", "Station Bagil", "Station Terry", "Station Sybil", "Citadel Station"]:
